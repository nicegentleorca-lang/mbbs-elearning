...
export default function Login() {
  ...
  return (
    // Login is rendered OUTSIDE <Layout /> (see App.jsx), so it has no
    // header/main/footer to rely on. This page must handle its own full
    // height and its own footer — no negative-margin tricks needed here,
    // since there's no parent padding to cancel in the first place.
    <div className="min-h-screen bg-ink flex flex-col">
      ...
      {/* Login's own footer — matches Layout's footer content exactly,
          since Layout's footer never renders on this route. */}
