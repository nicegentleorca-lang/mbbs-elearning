  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <h1 className="font-display text-3xl font-bold text-ink">Crash Courses</h1>
      </header>
        ...
        {subjects.map(subject => {
          ...
          return (
            <Link 
              ...
              className="index-card p-6 block group rounded-3xl"
            >
              <div className="flex items-start justify-between gap-3">
                ...
                {isOwned && (
                  <span className="text-[10px] font-mono uppercase tracking-widest text-gold bg-gold/10 border border-gold/30 rounded-full px-2.5 py-0.5 font-semibold shrink-0">
                    Unlocked
                  </span>
                )}
              </div>
